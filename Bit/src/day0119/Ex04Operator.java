...
/*
 * 연산자 (operator)
 * 연산자란 특정 수학 기호에 프로그래밍 기능을 정의해 놓은 것이다.
 * 
 * 연산자에는 크게
 * 산술
 * 할당
...
public class Ex04Operator {
	public static void main(String[] args) {
		...
		// String 이란?
		// String은 클래스로써 여러 개의 문자를 할당가능한 데이터타입이다.
		// String 값은 ""안에 적힌 글자들이 값이 된다.
		// 우리가 코드상으로 만들어놓은 "" 안의 값은
		// 힙 메모리 영역 안에 스트링 풀 이라는 곳에 정의가 된다.
		...
		// String에 더하기 연산을 하면 앞의 내용과 뒤의 내용을 모둥 String으로 만들고
		// 두 내용을 이어붙여라 라는 뜻이 된다.
		
		// 예를 들어서 string + "DEF"를 하게 되면?
		// string의 현재 해당 주소값에 저장된 "abc"라는 글자와 "DEF"를 연결해서
		// "abcDEF"라는 String을 만들라는 의미가 된다.
		
		// "number의 현재값: " + number의 경우
		// number 변수안에 저장된 값을 String, 즉 글자로 바꾸고 "number의 현재값: " 뒤에 이어붙이라는 이야기가 된다 .
	}
}
