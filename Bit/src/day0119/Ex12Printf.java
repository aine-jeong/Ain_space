...
/*
 * printf의 사용법
 * printf는 우리가 형식에 맞추어 출력할 내용을 %문자를 사용하여 형식을 지정해주게 된다.
 * 
 */
...
public class Ex12Printf {
	public static void main(String[] args) {
		...
		// C. 10진법 정수를 3자리 오른쪽 정렬 해서 출력해라
		//  ## 만약 출력해야할 내용이 우리가 지정할 자릿수보다 많으면 우리가 지정한 자릿수는 무시가 된다.
		System.out.printf("1-C. [%3d]\n", number);
		// D. 10진법 정수를 10자리 왼쪽 정렬해서 출력해라
		System.out.printf("1-D. [%-10d]\n", number);
		// E. 10진법 정소를 10자리 오른쪽 정렬하고, 왼쪽 빈자리는 0으로 채워서 출력해라
		...
		// E. 16진법 정수를 8자리 오른쪽 정렬하고 알파벳이 있으면 대문자로 출력하되 왼쪽 빈자리는 0으로 채워라
		System.out.printf("2-E. [%08X]\n", number);
		
		// 3. 실수('f'loat)
		//    비록 우리가 %f를 사용하지만 실제로는 double이던 float이던 상관없다.
		double d = 12.345;
		// A. 실수를 그대로 출력해라
		...
		// F. 실수를 소숫점 2번째 자리까지 출력하고 총 6자리로 출력해라.
