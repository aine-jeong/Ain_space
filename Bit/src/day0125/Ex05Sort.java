...
/*
 * 정렬
 * 정렬이란 값에 따라서 오름차순 혹은 내림차순으로 배열 안의 값들을 정리해주는 것
...
public class Ex05Sort {
	public static void main(String[] args) {
		int[] intArray = {3,1,9,6,8,2};
		
		for(int i = 0; i < intArray.length; i++) {
			System.out.printf("intArray[%d]: %d\n", i, intArray[i]);
		}
	
		// 우리가 구현할 정렬 방법은 인덱스와 그 다음 인덱스의 값을 비교해서
		// 만약 다음 인덱스가 더 작으면 두개의 위치를 바꿔주고 처음부터 다시 검사하는 형식으로 진행되게 된다.
